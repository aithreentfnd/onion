...
# لینک مستقیم لوگو (همون لینکی که دادی)
...
:root{--bg:#05070A;--card:rgba(8,11,16,0.92);--accent:#2563EB;--accent2:#2DD4BF;--text:#E8F4FF;--dim:#3D6B8E;--mid:#7BAED4;--border:rgba(37,99,235,0.25);--shadow:0 8px 32px rgba(0,0,0,0.45)}
[data-theme="light"]{--bg:#EFF6FB;--card:rgba(255,255,255,0.85);--accent:#1D4ED8;--accent2:#2563EB;--text:#0F172A;--dim:#64748B;--mid:#334155;--border:rgba(37,99,235,0.2);--shadow:0 8px 32px rgba(0,0,0,0.08)}
...
.bg{position:fixed;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(37,99,235,0.1),transparent 70%),var(--bg);z-index:0;transition:background .3s}
...
.orb{position:fixed;border-radius:50%;filter:blur(110px);opacity:.55;z-index:0;animation:fl 11s ease-in-out infinite}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:26px;padding:38px 34px 34px;backdrop-filter:blur(14px);box-shadow:var(--shadow)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:50%;overflow:hidden;border:2px solid var(--border);box-shadow:0 0 20px rgba(37,99,235,0.3),0 0 12px rgba(37,99,235,0.2);flex-shrink:0}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(37,99,235,0.07);border:1px solid rgba(37,99,235,0.15);border-radius:13px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(37,99,235,0.1);border:1px solid rgba(37,99,235,0.25);padding:3px 11px;border-radius:10px;cursor:pointer;transition:.15s;letter-spacing:.08em}
...
input[type=password]{width:100%;padding:13px 44px 13px 16px;border-radius:16px;border:1px solid var(--border);background:rgba(0,0,0,.15);color:var(--text);font-family:inherit;font-size:14px;outline:none;transition:.2s}
[data-theme="light"] input[type=password]{background:rgba(255,255,255,.5)}
input[type=password]:focus{border-color:rgba(37,99,235,.55);background:rgba(0,0,0,.2);box-shadow:0 0 0 3px rgba(37,99,235,.1)}
...
.err{display:none;background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.2);border-radius:13px;padding:10px 14px;margin-bottom:14px;font-size:12px;color:#F87171;align-items:center;gap:8px}
.err.show{display:flex}
.btn{width:100%;padding:13px;border-radius:16px;border:none;cursor:pointer;background:linear-gradient(135deg,#2563EB,#2DD4BF);color:#fff;font-family:inherit;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 20px rgba(37,99,235,.35);transition:.2s;position:relative;overflow:hidden}
...
<div class="wrap">
  <div class="card">
    ...
    <div class="footer">SpaceZone v10.0</div>
  </div>
</div>
<script>
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
  --bg:#05070A;--bg2:#0A0E14;--bg3:#10151D;
  --card:#0B0F16;--card-b:rgba(37,99,235,0.15);--card-bh:rgba(37,99,235,0.3);
  --accent:#2563EB;--accent2:#2DD4BF;--accent-d:rgba(37,99,235,0.12);
...
[data-theme="light"]{
  --bg:#EFF6FB;--bg2:#E0EEFB;--bg3:#CFE4F7;
  --card:#FFFFFF;--card-b:rgba(37,99,235,0.15);--card-bh:rgba(37,99,235,0.35);
  --accent:#1D4ED8;--accent2:#2563EB;--accent-d:rgba(14,116,144,0.08);
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:2px solid var(--card-b);box-shadow:0 0 14px rgba(37,99,235,.3);flex-shrink:0}
...
.nav-badge{margin-right:auto;background:rgba(37,99,235,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:26px;font-weight:700}
.sb-foot{padding:12px 14px;border-top:1px solid var(--card-b)}
.theme-btn{display:flex;align-items:center;justify-content:center;gap:7px;background:var(--accent-d);color:var(--t2);border-radius:12px;padding:8px;font-size:12px;font-weight:500;font-family:inherit;border:1px solid var(--card-b);cursor:pointer;width:100%;transition:.15s;margin-bottom:7px}
.theme-btn:hover{background:var(--card-b);color:var(--t1)}
.logout-btn{display:flex;align-items:center;justify-content:center;gap:7px;background:var(--red-bg);color:var(--red-t);border-radius:12px;padding:8px;font-size:12px;font-weight:500;font-family:inherit;border:1px solid rgba(239,68,68,0.2);cursor:pointer;width:100%;transition:.15s;margin-top:6px}
...
.menu-btn,.theme-mob{background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:34px;height:34px;border-radius:11px;font-size:17px;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:.15s}
...
.badge{font-size:10px;padding:3px 10px;border-radius:26px;font-weight:700;display:inline-flex;align-items:center;gap:5px;white-space:nowrap}
...
.traf-main-stat{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:26px;padding:22px 24px;position:relative;overflow:hidden}
...
.traf-trend{display:inline-flex;align-items:center;gap:4px;font-size:11px;font-weight:700;padding:4px 10px;border-radius:26px;margin-top:12px;position:relative;z-index:1}
.traf-trend.up{background:var(--green-bg);color:var(--green-t)}
.traf-trend.down{background:var(--red-bg);color:var(--red-t)}
.traf-mini{background:var(--card);border:1px solid var(--card-b);border-radius:26px;padding:18px 19px;display:flex;flex-direction:column;justify-content:space-between;transition:.2s}
...
.traf-mini-icon{width:32px;height:32px;border-radius:12px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:15px}
...
.traf-chart-card{background:var(--card);border:1px solid var(--card-b);border-radius:29px;padding:22px 24px 18px;box-shadow:var(--shadow);margin-bottom:16px}
...
.m-icon{width:34px;height:34px;border-radius:11px;background:var(--accent-d);display:flex;align-items:center;justify-content:center;margin-bottom:11px;color:var(--accent);font-size:17px}
...
.vless-box{background:linear-gradient(135deg,var(--bg3) 0%,var(--bg2) 100%);border:1px solid var(--card-b);border-radius:23px;padding:20px 22px;margin-bottom:18px;box-shadow:var(--shadow);position:relative;overflow:hidden;transition:background .3s}
...
.vl-code{background:rgba(0,0,0,.18);border:1px solid var(--card-b);border-radius:12px;padding:13px 15px;font-size:11px;font-family:ui-monospace,monospace;color:var(--accent2);word-break:break-all;line-height:1.8;letter-spacing:.01em}
[data-theme="light"] .vl-code{background:rgba(0,0,0,.04)}
.vl-actions{display:flex;gap:8px;margin-top:13px;flex-wrap:wrap}
.btn{font-family:inherit;font-size:12px;font-weight:500;border-radius:12px;padding:8px 14px;cursor:pointer;display:inline-flex;align-items:center;gap:5px;border:none;transition:all .15s;white-space:nowrap}
.btn i{font-size:13px}
.btn:disabled{opacity:.4;cursor:not-allowed}
.btn-p{background:linear-gradient(135deg,#2563EB,#2DD4BF);color:#fff;box-shadow:0 2px 14px rgba(37,99,235,.35)}
...
.btn-pur{background:var(--purple-bg);color:#A78BFA;border:1px solid rgba(168,85,247,.2)}
...
.btn-sm{padding:5px 9px;font-size:10.5px;border-radius:10px}
...
.exp-chip{font-size:9px;padding:3px 8px;border-radius:7px;font-weight:700;display:inline-flex;align-items:center;gap:3px}
...
.tog{width:19px;height:34px;border-radius:25px;background:rgba(100,116,139,0.25);position:relative;cursor:pointer;transition:.2s;flex-shrink:0;border:none}
...
.fi,.fs{padding:9px 12px;border-radius:12px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12px;outline:none;transition:.15s;min-width:100px}
...
.cl{background:var(--accent-d);border:1px solid rgba(37,99,235,.15);border-radius:13px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
/* ══════ پنل ساخت کانفیگ ══════ */
.create-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 55%);border:1px solid var(--card-b);border-radius:29px;padding:0;overflow:hidden;box-shadow:var(--shadow);margin-bottom:16px;position:relative}
...
.cp-head-icon{width:44px;height:44px;border-radius:17px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(37,99,235,.35)}
...
.cp-block{background:rgba(0,0,0,.14);border:1px solid var(--card-b);border-radius:18px;padding:14px 16px}
[data-theme="light"] .cp-block{background:rgba(14,116,144,.03)}
...
.cp-input-full{width:100%;padding:10px 13px;border-radius:13px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.15s}
...
.chip{font-size:10.5px;font-weight:700;padding:5px 12px;border-radius:11px;background:var(--accent-d);color:var(--t2);border:1px solid var(--card-b);cursor:pointer;transition:.15s;white-space:nowrap}
...
.proto-card{border:1.5px solid var(--card-b);border-radius:17px;padding:13px 12px;cursor:pointer;transition:.18s;text-align:center;position:relative;background:rgba(0,0,0,.1)}
...
.proto-card-icon{width:32px;height:32px;border-radius:12px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:16px;margin:0 auto 8px}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;border:none;border-radius:17px;padding:13px 26px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(37,99,235,.35);transition:.18s;white-space:nowrap}
...
/* ══════ پنل اطلاعات سرور ══════ */
.srv-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:29px;overflow:hidden;box-shadow:var(--shadow);position:relative}
...
.srv-hero-icon{width:50px;height:50px;border-radius:18px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(37,99,235,.35)}
...
.srv-tile{display:flex;align-items:center;gap:11px;background:rgba(0,0,0,.14);border:1px solid var(--card-b);border-radius:17px;padding:12px 14px;transition:.18s}
[data-theme="light"] .srv-tile{background:rgba(14,116,144,.03)}
.srv-tile:hover{border-color:var(--card-bh);transform:translateY(-1px)}
.srv-tile-icon{width:34px;height:34px;border-radius:13px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0}
...
/* ══════ پنل تغییر رمز ══════ */
.pw-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:29px;overflow:hidden;box-shadow:var(--shadow);position:relative}
...
.pw-hero-icon{width:50px;height:50px;border-radius:18px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(168,85,247,.35)}
...
.pw-input{width:100%;padding:11px 42px 11px 14px;border-radius:14px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.15s}
...
.pw-strength{height:4px;border-radius:4px;background:var(--accent-d);margin-top:8px;overflow:hidden;display:flex;gap:3px}
.pw-strength-seg{flex:1;height:100%;border-radius:4px;background:rgba(100,116,139,.2);transition:.25s}
...
.pw-req{font-size:9.5px;padding:4px 10px;border-radius:10px;background:var(--accent-d);color:var(--t3);font-weight:600;display:flex;align-items:center;gap:4px;transition:.18s}
.pw-req.met{background:var(--green-bg);color:var(--green-t)}
.pw-submit{width:100%;justify-content:center;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;border-radius:16px;padding:12px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 18px rgba(168,85,247,.32);transition:.18s}
...
.conn-hero-tile{background:var(--card);border:1px solid var(--card-b);border-radius:21px;padding:16px 18px;position:relative;overflow:hidden;transition:.2s}
...
.conn-hero-icon{width:32px;height:32px;border-radius:12px;background:var(--green-bg);color:var(--green-t);display:flex;align-items:center;justify-content:center;font-size:15px;margin-bottom:10px}
...
.conn-live-badge{display:flex;align-items:center;gap:6px;font-size:10.5px;font-weight:700;color:var(--green-t);background:var(--green-bg);padding:5px 12px;border-radius:26px;border:1px solid rgba(34,197,94,.2)}
...
.conn-card-v2{background:var(--card);border:1px solid var(--card-b);border-radius:23px;padding:0;overflow:hidden;transition:all .22s cubic-bezier(.4,0,.2,1);position:relative}
.conn-card-v2:hover{border-color:var(--card-bh);transform:translateY(-3px);box-shadow:0 14px 32px rgba(0,0,0,.22)}
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(34,197,94,.1),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:17px;background:linear-gradient(135deg,var(--green),#0D9668);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 14px rgba(34,197,94,.3)}
.conn-avatar::after{content:'';position:absolute;inset:-4px;border-radius:21px;border:1.5px solid var(--green);opacity:.4;animation:breathe2 2.4s ease-in-out infinite}
...
.conn-status-pill{font-size:9px;font-weight:800;padding:4px 9px;border-radius:26px;background:var(--green-bg);color:var(--green-t);display:flex;align-items:center;gap:4px;white-space:nowrap;flex-shrink:0}
...
.conn-stat-icon{width:26px;height:26px;border-radius:11px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0}
...
.conn-duration-track{height:5px;border-radius:5px;background:var(--accent-d);overflow:hidden;position:relative}
.conn-duration-fill{height:100%;border-radius:5px;background:linear-gradient(90deg,var(--green),#4ADE80);position:relative;overflow:hidden}
...
.conn-empty-v2{text-align:center;padding:70px 20px;background:var(--card);border:1px dashed var(--card-b);border-radius:26px}
.conn-empty-v2-icon{width:64px;height:64px;border-radius:23px;background:var(--accent-d);display:flex;align-items:center;justify-content:center;font-size:28px;color:var(--t3);margin:0 auto 16px}
...
.sub-box{background:rgba(168,85,247,.07);border:1px solid rgba(168,85,247,.2);border-radius:13px;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:11px}
.sub-url{font-family:ui-monospace,monospace;font-size:10.5px;color:#A78BFA;word-break:break-all;flex:1}
.spbar{height:4px;border-radius:4px;background:var(--accent-d);margin-top:5px;overflow:hidden}
...
.subs-search input{width:100%;padding:11px 40px 11px 15px;border-radius:16px;border:1px solid var(--card-b);background:var(--card);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.15s}
...
.sub-card{background:var(--card);border:1px solid var(--card-b);border-radius:26px;padding:0;overflow:hidden;transition:all .25s cubic-bezier(.4,0,.2,1);position:relative}
...
.sub-card-icon{width:46px;height:46px;border-radius:18px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(168,85,247,.35)}
...
.sub-card-lock-badge{flex-shrink:0;width:26px;height:26px;border-radius:11px;display:flex;align-items:center;justify-content:center;font-size:12px}
...
.sub-card-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:0;position:relative;z-index:1;margin-top:16px;background:rgba(0,0,0,.14);border:1px solid var(--card-b);border-radius:17px;overflow:hidden}
...
.sub-card-url-row{margin:14px 20px 0;background:rgba(168,85,247,.08);border:1px dashed rgba(168,85,247,.25);border-radius:14px;padding:9px 12px;display:flex;align-items:center;gap:8px}
...
.subs-empty-v2{text-align:center;padding:70px 20px;background:var(--card);border:1px dashed var(--card-b);border-radius:26px;grid-column:1/-1}
.subs-empty-v2-icon{width:64px;height:64px;border-radius:23px;background:var(--purple-bg);display:flex;align-items:center;justify-content:center;font-size:28px;color:var(--purple);margin:0 auto 16px}
...
/* ══════ مودال ساخت گروه ══════ */
.modal-v2{background:var(--card);border:1px solid var(--card-b);border-radius:29px;padding:0;max-width:430px;width:calc(100% - 32px);max-height:92vh;overflow-y:auto;position:relative;animation:fi .2s ease;box-shadow:0 24px 70px rgba(0,0,0,.5)}
...
.modal-v2-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:12px;font-size:15px;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:2;transition:.15s}
.modal-v2-close:hover{background:var(--red-bg);color:var(--red-t);border-color:rgba(239,68,68,.25)}
.modal-v2-icon{width:42px;height:42px;border-radius:17px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 18px rgba(168,85,247,.4)}
...
.modal-v2-input{width:100%;padding:9px 38px 9px 13px;border-radius:14px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.18s}
...
.modal-v2-hint{background:rgba(37,99,235,.08);border:1px solid rgba(37,99,235,.18);border-radius:14px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.modal-v2-btn-cancel{flex:.75;justify-content:center;padding:10px;border-radius:14px;background:transparent;border:1px solid var(--card-b);color:var(--t2);font-family:inherit;font-size:12px;font-weight:700;cursor:pointer;transition:.15s;display:flex;align-items:center}
.modal-v2-btn-cancel:hover{background:var(--accent-d);color:var(--t1)}
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(168,85,247,.4);transition:.18s}
...
.lmodal-icon{width:44px;height:44px;border-radius:17px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(37,99,235,.35)}
...
.lmodal-search input{width:100%;padding:10px 38px 10px 13px;border-radius:14px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12px;outline:none}
...
.lmodal-qbtn{font-size:10px;font-weight:700;padding:5px 11px;border-radius:11px;background:var(--accent-d);color:var(--accent2);border:1px solid var(--card-b);cursor:pointer;transition:.15s;font-family:inherit}
...
.lrow-v2{display:flex;align-items:center;gap:11px;padding:11px 12px;border-radius:17px;cursor:pointer;transition:.15s;margin-bottom:4px;border:1px solid transparent}
.lrow-v2:hover{background:var(--accent-d)}
.lrow-v2.checked{background:rgba(37,99,235,.1);border-color:rgba(37,99,235,.25)}
.lrow-v2-check{width:20px;height:20px;border-radius:10px;border:2px solid var(--card-b);flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:.15s;background:rgba(0,0,0,.14)}
...
.lrow-v2-avatar{width:34px;height:34px;border-radius:13px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0}
...
.lrow-v2-status{font-size:9px;font-weight:800;padding:3px 9px;border-radius:26px;flex-shrink:0;white-space:nowrap}
...
.modal{background:var(--card);border:1px solid var(--card-b);border-radius:26px;padding:28px 26px;max-width:520px;width:calc(100% - 32px);max-height:90vh;overflow-y:auto;position:relative;animation:fi .2s ease}
.modal-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:11px;font-size:16px;display:flex;align-items:center;justify-content:center;cursor:pointer;border:none}
...
.lrow-check{width:16px;height:16px;border-radius:5px;cursor:pointer;accent-color:var(--accent)}
.lrow-label{flex:1;font-size:12px;color:var(--t1)}
.lrow-badge{font-size:9px;padding:2px 7px;border-radius:6px;background:var(--green-bg);color:var(--green-t);font-weight:700}
.toast{position:fixed;bottom:22px;left:50%;transform:translateX(-50%) translateY(40px);background:var(--card);border:1px solid var(--card-b);color:var(--t1);border-radius:13px;padding:10px 18px;font-size:12.5px;opacity:0;transition:all .25s;z-index:999;pointer-events:none;display:flex;align-items:center;gap:8px;box-shadow:var(--shadow);white-space:nowrap}
.toast.show{opacity:1;transform:translateX(-50%) translateY(0)}
.toast.ok{border-color:rgba(34,197,94,.3);background:var(--green-bg);color:var(--green-t)}
...
.cfg-card{background:var(--card);border:1px solid var(--card-b);border-radius:18px;padding:0;transition:all .2s cubic-bezier(.4,0,.2,1);position:relative;overflow:hidden}
...
.cfg-uuid-mini{font-family:ui-monospace,monospace;font-size:9.5px;color:var(--accent2);background:var(--accent-d);padding:2px 7px;border-radius:6px;cursor:pointer;transition:.15s}
...
.ubar{height:5px;border-radius:5px;background:rgba(37,99,235,0.1);overflow:hidden}
.ubar-f{height:100%;border-radius:5px;transition:width .4s ease}
...
.tog{width:19px;height:30px;border-radius:25px;background:rgba(100,116,139,0.25);position:relative;cursor:pointer;transition:.2s;flex-shrink:0;border:none}
...
.conn-card{background:var(--card);border:1px solid var(--card-b);border-radius:21px;padding:15px 17px;transition:.2s;position:relative;overflow:hidden}
...
.conn-ip-icon{width:32px;height:32px;border-radius:12px;background:var(--green-bg);color:var(--green-t);display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0}
...
.log-ic{width:30px;height:30px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0}
...
.log-kind{font-size:8.5px;padding:1px 7px;border-radius:13px;background:var(--accent-d);color:var(--accent2);font-weight:700;text-transform:uppercase;letter-spacing:.04em}
...
.emsg{color:var(--red-t);font-family:ui-monospace,monospace;background:var(--red-bg);padding:6px 9px;border-radius:7px;word-break:break-all;font-size:10.5px}
...
<section class="pg" id="pg-testws">
  ...
  <div class="card" style="max-width:660px">
    ...
    <div style="background:rgba(0,0,0,.3);border:1px solid var(--card-b);border-radius:13px;padding:14px;height:250px;overflow-y:auto;font-family:ui-monospace,monospace;font-size:10.5px;line-height:1.9" id="ws-log">
...
async function loadSubsPage(){
  ...
  try{
    ...
    el.innerHTML=subs.map(s=>`
      <div style="padding:13px 15px;background:var(--accent-d);border:1px solid var(--card-b);border-radius:13px;margin-bottom:8px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap">
        <div>
...
function checkPwStrength(val){
  ...
  const colors=['#EF4444','#F59E0B','#2DD4BF','#22C55E'],labels=['خیلی ضعیف','ضعیف','متوسط','قوی'];
...
function initCharts(){
  ...
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(37,99,235,.3)',borderWidth:1,
  ...
  ch3=new Chart(document.getElementById('ch3'),{
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(13,27,46,.97)',borderColor:'rgba(37,99,235,.35)',borderWidth:1,
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(13,27,46,.96)',borderColor:'rgba(37,99,235,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#4ADE80',err:'#F87171',info:'#7BAED4',sent:'#FCD34D'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
:root{{
  --bg:#050608;--bg2:#0A0D12;--bg3:#0E121A;
  --card:#0A0E15;--card-b:rgba(37,99,235,0.14);--card-bh:rgba(37,99,235,0.3);
  --accent:#2563EB;--accent2:#2DD4BF;--accent-d:rgba(37,99,235,0.1);
  --green:#22C55E;--green-bg:rgba(34,197,94,0.1);--green-t:#4ADE80;
  --red:#EF4444;--red-bg:rgba(239,68,68,0.1);--red-t:#FB8585;
  --amber:#F2A33D;--amber-bg:rgba(242,163,61,0.1);--amber-t:#F9C988;
  --purple:#C084FC;--purple-bg:rgba(192,132,252,0.1);--purple-t:#D8B4FE;
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:2px solid var(--card-b);box-shadow:0 0 14px rgba(37,99,235,.3);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
...
.icon-btn{{width:36px;height:36px;border-radius:14px;background:var(--card);border:1px solid var(--card-b);color:var(--t2);display:flex;align-items:center;justify-content:center;font-size:16px;cursor:pointer;transition:.18s}}
.icon-btn:hover{{background:var(--accent-d);color:var(--accent2);border-color:var(--card-bh)}}

.sub-info{{background:var(--card);border:1px solid var(--card-b);border-radius:29px;padding:24px 24px 22px;margin-bottom:16px;box-shadow:var(--shadow);position:relative;overflow:hidden}}
...
.sub-sub-box{{background:var(--accent-d);border:1px solid var(--card-b);border-radius:17px;padding:12px 14px;display:flex;align-items:center;gap:9px;flex-wrap:wrap}}
...
.stat-card{{background:var(--card);border:1px solid var(--card-b);border-radius:21px;padding:16px 17px;transition:.2s}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#1D4ED8 100%);border-radius:23px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(37,99,235,.28);flex-wrap:wrap}}
...
.copy-all-btn{{background:#fff;color:#1D4ED8;border:none;border-radius:16px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.18s;white-space:nowrap}}
...
.cfg-card{{background:var(--card);border:1px solid var(--card-b);border-radius:23px;transition:all .2s;position:relative;overflow:hidden}}
...
.proto-chip{{font-size:9px;padding:3px 8px;border-radius:10px;font-weight:800;letter-spacing:.02em}}
.pc-ws{{background:var(--accent-d);color:var(--accent2)}}
.pc-xhttp{{background:var(--purple-bg);color:var(--purple-t)}}
.pc-ultra{{background:var(--green-bg);color:var(--green-t)}}
.cfg-status{{display:flex;align-items:center;gap:5px;font-size:10px;font-weight:700;padding:4px 10px;border-radius:26px;white-space:nowrap}}
...
.ubar{{height:6px;border-radius:5px;background:rgba(37,99,235,0.1);overflow:hidden;margin-bottom:5px}}
...
.cfg-link-toggle{{width:100%;display:flex;align-items:center;justify-content:space-between;gap:10px;background:transparent;border:1px dashed var(--card-b);border-radius:14px;padding:10px 13px;cursor:pointer;font-family:inherit;color:var(--t2);font-size:11.5px;font-weight:600;transition:.15s}}
...
.cfg-vless{{background:rgba(0,0,0,.22);border:1px solid var(--card-b);border-radius:13px;padding:11px 13px;font-size:9.8px;font-family:ui-monospace,monospace;color:var(--accent2);word-break:break-all;line-height:1.7;margin-top:9px;max-height:90px;overflow-y:auto}}
[data-theme="light"] .cfg-vless{{background:rgba(14,116,144,.05)}}
.cfg-actions{{display:flex;gap:7px;flex-wrap:wrap;margin-top:11px}}
.btn{{font-family:inherit;font-size:11.5px;font-weight:700;border-radius:13px;padding:8px 15px;cursor:pointer;display:inline-flex;align-items:center;gap:5px;border:none;transition:all .15s;white-space:nowrap}}
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(135deg,#2563EB,#2DD4BF);color:#fff;box-shadow:0 3px 14px rgba(37,99,235,.35)}}
...
.btn-pur{{background:var(--purple-bg);color:var(--purple-t);border:1px solid rgba(192,132,252,.2)}}
.btn-pur:hover{{background:rgba(192,132,252,.22)}}
.conn-chip{{display:inline-flex;align-items:center;gap:4px;font-size:9.5px;padding:3px 8px;border-radius:26px;background:var(--green-bg);color:var(--green-t);font-weight:700}}
...
.lock-card{{background:var(--card);border:1px solid var(--card-b);border-radius:34px;padding:0;text-align:center;max-width:380px;width:100%;box-shadow:var(--shadow);overflow:hidden;position:relative}}
...
.lock-shield{{width:64px;height:64px;border-radius:23px;background:var(--accent-d);border:1px solid var(--card-bh);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;position:relative}}
.lock-shield::after{{content:'';position:absolute;inset:-7px;border-radius:29px;border:1px solid var(--card-b);animation:breathe 2.6s ease-in-out infinite}}
...
.lock-inp{{width:100%;padding:13px 44px 13px 44px;border-radius:17px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:14px;outline:none;text-align:center;letter-spacing:.14em;transition:.18s}}
[data-theme="light"] .lock-inp{{background:rgba(14,116,144,.04)}}
...
.lock-btn{{width:100%;justify-content:center;padding:13px;font-size:13px;border-radius:17px}}
...
.toast{{position:fixed;bottom:22px;left:50%;transform:translateX(-50%) translateY(40px);background:var(--card);border:1px solid var(--card-b);color:var(--t1);border-radius:16px;padding:10px 20px;font-size:12.5px;font-weight:600;opacity:0;transition:all .25s;z-index:999;pointer-events:none;display:flex;align-items:center;gap:7px;box-shadow:var(--shadow);white-space:nowrap}}
.toast.show{{opacity:1;transform:translateX(-50%) translateY(0)}}
...
.qr-box{{background:var(--card);border:1px solid var(--card-b);border-radius:29px;padding:26px;text-align:center;max-width:340px;width:100%;box-shadow:var(--shadow)}}
.qr-title{{font-size:13.5px;font-weight:800;margin-bottom:16px;color:var(--t1)}}
.qr-img{{border-radius:18px;overflow:hidden;margin-bottom:15px}}
.qr-img img{{width:100%;display:block;background:#fff;padding:10px;border-radius:18px}}
