...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#0D9488 100%);border-radius:23px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(37,99,235,.28);flex-wrap:wrap}}
